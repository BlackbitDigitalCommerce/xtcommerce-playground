...
class shipping extends xt_backend_cls {
    ...
    */
	...
	function _getParams() {
		...
		$js .= "addTab('adminHandler.php?load_section=shipping_price&pg=overview&shipping_id='+edit_id,'".TEXT_SHIPPING_PRICE." '+edit_name,'shipping_price_'+edit_id)";
	...
	function _set($data, $set_type = 'edit'){
        ...
        elseif ($set_type=='new' &&  empty($data['shipping_code'])) {
            $data['shipping_code'] = __define('TEXT_SHIPPING_CODE');
        }
