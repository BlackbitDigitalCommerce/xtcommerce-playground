...
if($page->page_name == 'product')
{
    ...
    $product_ld["offers"] = [
        ...
        "price" => round($p_info->data["products_price"]["plain"], 2)
      ];
    ...
    else if(array_key_exists('xt_reviews', $xtPlugin->active_modules) && $p_info->data["products_rating_count"] > 0 )
    {
        ...
        $per_page   = defined('XT_REVIEWS_EXPORT_PER_PAGE') && !empty(XT_REVIEWS_EXPORT_PER_PAGE) ? XT_REVIEWS_EXPORT_PER_PAGE : 20;
