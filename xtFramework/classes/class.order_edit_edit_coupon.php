...
class order_edit_edit_coupon extends xt_backend_cls {
	...
	function _getParams() {
		...
		$header['current_coupon_code'] = array('type'=>'hidden', 'width' => 500, 'text'=>__define('TEXT_ORDER_EDIT_CURRENT_COUPON_CODE'));
        $header['current_coupon_code_show'] = array('type'=>'textfield', 'width' => 500, 'readonly' => true, 'text'=>__define('TEXT_ORDER_EDIT_CURRENT_COUPON_CODE'));
        $header['new_coupon_code_coupons'] = array('type'=>'dropdown', 'width' => 500, 'url'  => 'DropdownData.php?get=order_edit_coupons','text'=>__define('TEXT_ORDER_EDIT_NEW_COUPON_CODE_TEMPLATE'));
        $header['new_coupon_code_code'] = array('type'=>'textfield', 'width' => 500, 'text'=>__define('TEXT_ORDER_EDIT_NEW_COUPON_CODE_CODE'));
        ...
        $rowActions[] = array('iconCls' => 'ORDER_EDIT_SAVE_COUPON', 'qtipIndex' => 'qtip1', 'tooltip' => __define('TEXT_ORDER_EDIT_SAVE_COUPON'));
        ...
        $rowActions[] = array('iconCls' => 'ORDER_EDIT_REMOVE_COUPON', 'qtipIndex' => 'qtip1', 'tooltip' => __define('TEXT_ORDER_EDIT_REMOVE_COUPON'));
