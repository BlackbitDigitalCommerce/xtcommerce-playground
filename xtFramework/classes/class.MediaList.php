...
class MediaList extends xt_backend_cls
{
    ...
    function _getParams ()
    {
        ...
        $menuGroups[] = array('group' => 'edit_data', 'group_name' => TEXT_EDIT, 'ToolbarPos' => 'Toolbar', 'Pos' => 'grid','iconCls'=>'fas fa-wrench'); // Toolbarpos = TopToolbar or Toolbar, Pos = grid / edit / both
        ...
        if ($is_data) {
            ...
            if ($this->url_data['get_data']) {
				...
				if (($this->url_data['mgID']==6) or ($this->url_data['mgID']==7))
				{
                    ...
                    define('TEXT_GROUP_PERMISSION_INFO2', TEXT_GROUP_PERMISSION_INFO);
