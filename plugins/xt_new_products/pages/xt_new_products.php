...
global $brotkrumen, $xtLink, $xtPlugin, $page;
...
if (XT_NEW_PRODUCTS_ACTIVATED == 1
    &&
    (
        ($page->page_name == 'index' && ACTIVATE_XT_NEW_PRODUCTS_START_PAGE == 1 ) ||
        ($page->page_name == 'xt_new_products' && ACTIVATE_XT_NEW_PRODUCTS_PAGE == 1 )
    )
){
    ...
    $tpl_data['total'] = $new_products_page_data_array['total'];
    $tpl_data['show_more'] = ACTIVATE_XT_NEW_PRODUCTS_PAGE == 1 && $new_products_page_data_array['total'] > $limit;
...
}else if($page->page_name == 'xt_new_products'){
