	...
	function generateTags()
	{
		...
		switch ($page->page_name)
		{
            ...
            case 'search':
                ...
                break;
            case 'cart':
                $this->pageTitle = constant('TEXT_CART');
            ...
            case 'checkout':
                ...
                {
                    case 'shipping':
                        $this->pageTitle = constant('TEXT_SELECT_SHIPPING');
                        break;
                    case 'payment':
                        $this->pageTitle = constant('TEXT_SELECT_PAYMENT');
                        break;
                    case 'confirmation':
                        $this->pageTitle = constant('TEXT_CONFIRMATION');
                        break;
                    case 'success':
                        $this->pageTitle = constant('TEXT_SUCCESS');
                        break;
                }
                if (_STORE_META_KEYWORDS=='') $this->tags['keywords'] = $this->_autoGenerateTags($this->PageContent);
                break;
		...
		if ( ! empty($_SESSION['orderEditAdminUser']))
		{
			...
			$this->pageTitle = TEXT_ORDER_EDIT_NEW_ORDER. (!empty($name) ? ' - '.$name : '');
		}
