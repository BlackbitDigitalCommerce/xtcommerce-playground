...
class order_edit_edit_address extends xt_backend_cls {
	...
	function _getParams() {
        ...
        $header['address_type_to_change'] = array('type'=>'dropdown', 'width' => 300, 'url'  => 'DropdownData.php?get=order_edit_address_type','text'=>__define('TEXT_ORDER_EDIT_ADDRESS_TYPE'));
        $header['address_book_id'] = array('type'=>'dropdown', 'width' => 500, 'url'  => 'DropdownData.php?get=order_edit_customer_addresses&plugin=order_edit&orders_id='.$this->url_data['orders_id'],'text'=>__define('TEXT_ORDER_EDIT_ADDRESS_TO_APPLY'));
        ...
        $msgFieldsMissing = __define('TEXT_ORDER_EDIT_FIELDS_REQUIRED') . ': '.
            __define('TEXT_CUSTOMERS_COMPANY').'/'.__define('TEXT_CUSTOMERS_LASTNAME') . ', '.
            __define('TEXT_CUSTOMERS_STREET_ADDRESS') . ', '.
            __define('TEXT_CUSTOMERS_POSTCODE') . ', '.
            __define('TEXT_CUSTOMERS_CITY') . ', '.
            __define('TEXT_CUSTOMERS_COUNTRY_CODE');
        ...
        $js_new = "
            ...
            {
                var title = '".__define('TEXT_ERROR_MSG')."';
        ...
        $rowActions[] = array('iconCls' => 'ORDER_EDIT_APPLY_NEW_ADDRESS', 'qtipIndex' => 'qtip1', 'tooltip' => __define('ORDER_EDIT_APPLY_NEW_ADDRESS'));
        ...
        $rowActions[] = array('iconCls' => 'ORDER_EDIT_APPLY_EDITED_ADDRESS', 'qtipIndex' => 'qtip1', 'tooltip' => __define('ORDER_EDIT_APPLY_EDITED_ADDRESS'));
        ...
        $rowActions[] = array('iconCls' => 'ORDER_EDIT_APPLY_EXISTING_ADDRESS', 'qtipIndex' => 'qtip1', 'tooltip' => __define('ORDER_EDIT_APPLY_EXISTING_ADDRESS'));
