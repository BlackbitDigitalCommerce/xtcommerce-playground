...
class export extends xt_backend_cls
{
    ...
    protected function makeAsyncCall2($url, $params = [])
    {
        ...
        try
        {
            ...
            $this->log('makeAsyncCall | sending request to '.$url.'?'.http_build_query($params));
        ...
        $this->log('makeAsyncCall | exiting with r->success = '. ($r->success ?: '0'));
        return $r;
    }
    ...
    function deliverTOftp ()
    {
        ...
        try {
            $connection_id = ftp_ssl_connect ($this->data['feed_ftp_server']);
    ...
    function _getParams ()
    {
        ...
        $header['feed_p_campaign'] = array(
            'type' => 'dropdown', // you can modyfy the auto type
            'url' => 'DropdownData.php?systemstatus=campaign&add_empty', 'text' => TEXT_CAMPAIGN_SELECT
        );
