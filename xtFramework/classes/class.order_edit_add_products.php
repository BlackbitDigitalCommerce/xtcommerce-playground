...
class order_edit_add_products extends product {
    ...
    function _getParams() {
        ...
        $rowActions[] = array('iconCls' => 'ORDER_EDIT_ADD_ITEM', 'qtipIndex' => 'qtip1', 'tooltip' => __define('TEXT_ORDER_EDIT_ADD_ITEM'));
        ...
        $rowActions[] = array('iconCls' => 'ORDER_EDIT_CALCULATE_GRADUATED', 'qtipIndex' => 'qtip1', 'tooltip' => __define('TEXT_ORDER_EDIT_CALCULATE_GRADUATED'));
    ...
    public function addOrderItem($data)
    {
        ...
        if ($oId && $opId)
        {
            ...
            if ($r->couponRemoved)
            {
                $result->msg = __define('TEXT_ORDER_EDIT_WARNING_COUPON_REMOVED');
                if ($r->errors)
                {
