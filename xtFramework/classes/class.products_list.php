...
class products_list {
	...
	function getSortDropdown() {
		...
		$options = array();
		$options[] = array('id'=>'','text'=>TEXT_SELECT_SORT);
        ...
        $options[] = array('id'=>'products_model','text'=>constant('TEXT_PRODUCTS_MODEL').' '.constant('TEXT_ASC'));
        $options[] = array('id'=>'products_model-desc','text'=>constant('TEXT_PRODUCTS_MODEL').' '.constant('TEXT_DESC'));
