...
class product  extends xt_backend_cls{
    ...
    */
	...
	function _getParams() {
		global $language, $xtPlugin, $customers_status, $db,$store_handler;
		...
		if($this->url_data['pg']=='overview' && !$this->url_data['edit_id'] && $this->url_data['new'] != true){
			...
			$menuGroups[] = array('group'=>'edit_data', 'group_name'=>TEXT_MULTI_ACTION_MENU, 'ToolbarPos'=>'Toolbar', 'Pos'=>'grid','iconCls'=>'fas fa-wrench'); // Toolbarpos = TopToolbar or Toolbar, Pos = grid / edit / both
	...
	public function stats() {
		...
		$filterPanel->setTitle(__define("TEXT_FILTER"))->setBaseCssClass('xt-filter-panel')
		->setAutoHeight(true);
